package com.laputa.controller.weixin.mymenu;
...
import com.laputa.util.weixin.MenuUtil;
import com.laputa.service.weixin.key.KeyManager;
import com.laputa.service.weixin.mymenu.MyMenuManager;
...
public class MyMenuController extends BaseController {
	...
	public boolean isNull(String value){
		return "".equals(value.replaceAll(",", "").trim());
	}
