package com.laputa.controller.weixin;
...
import com.laputa.service.weixin.command.CommandService;
import com.laputa.service.weixin.imgmsg.ImgmsgService;
import com.laputa.service.weixin.textmsg.TextmsgService;
	 ...
	 */
	 ...
	 public void index(
		...
		try{
			...
			logInfo(logger,"signature:"+signature+" timestamp:"+timestamp+" nonce:"+nonce+" echostr:"+echostr);
